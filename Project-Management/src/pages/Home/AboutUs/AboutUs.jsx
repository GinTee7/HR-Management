        ...
        <div className="flex flex-col items-center gap-8 md:flex-row">
          ...
          >
            <p className="text-lg leading-7 text-gray-700">
              CÔNG TY TNHH MINH LONG AGRO được xây dựng từ hoài bão phát triển
              nông nghiệp của những con người đã có hơn 30 năm gắn bó với nông
              nghiệp. Các sản phẩm do Công Ty Minh Long sản xuất và phân phối
              luôn đáp ứng các tiêu chí khắt khe về chất lượng, được các cơ quan
              quản lý công nhận, được người nông dân tin dùng.
            </p>
          </motion.div>
          <motion.div
      ...
      >
        ...
        <div className="container relative px-6 mx-auto text-center">
          ...
          <p className="mt-4 text-lg">
            Tham gia cùng chúng tôi trên hành trình mang lại giá trị cho cộng
            đồng.
          </p>
          <motion.button
