...
//                 setUser({ username: response.username, role: response.token.roleName });
//             } else {
...
//             switch (response.token.roleName) {
//                 case 'ADMIN':
...
//                     <img src={logo} alt={t('Enterprise Logo')} className='object-contain w-[80%] h-auto shadow-xl rounded-lg' />
//                 </div>

//                 <div className='flex flex-col justify-center w-full p-8 bg-white md:w-1/2'>
//                     <div className='flex justify-end mb-4 space-x-2'>
//                         <button onClick={() => changeLanguage('en')} className='px-3 py-1 text-sm font-semibold transition bg-gray-200 rounded-md hover:bg-gray-300'>EN</button>
//                         <button onClick={() => changeLanguage('vi')} className='px-3 py-1 text-sm font-semibold transition bg-gray-200 rounded-md hover:bg-gray-300'>VI</button>
//                     </div>

//                     <h2 className='mb-6 text-2xl font-bold text-center text-gray-800'>{t('Welcome Back')}</h2>
...
//                             <a href='/forgot-password' className='text-sm font-medium text-teal-700 hover:underline'>{t('Forgot your password?')}</a>
//                         </div>
//                         <div className='mt-4 text-center'>
//                             <p className='text-gray-700'>{t("Don't have an account?")}</p>
//                             <button type='button' onClick={() => navigate('/signup')} className='font-medium text-teal-700 hover:underline'>{t('Create an account')}</button>
//                         </div>
//                     </form>
//                 </div>
//             </div>
