...
const Services = () => {
  ...
  return (
    <div className="bg-[#F2F8FC] py-10" style={{ backgroundImage: `url(${homePageBanner})` }}>
      {/* Services*/}
      <div className="container">
        ...
        {servicesData.length > 0 ? (
          ...
          <p className="mt-8 text-center text-gray-500">Đang tải sản phẩm...</p>
        )}
      </div>

      {/* Banner */}
      <div
        className="min-h-[550px] flex justify-center items-center py-12 sm:py-0 relative bg-cover bg-center mt-10"
        ...
        <div className="container p-10 bg-white rounded-lg shadow-lg ">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div className="flex flex-col justify-center gap-6 sm:pt-0">
              ...
              >
                Công Ty TNHH BVTV Minh Long được xây dựng từ hoài bão phát triển
                nông nghiệp của những con người đã có hơn 30 năm gắn bó với nông
                nghiệp.
                <br />
                <br />
                Thấu hiểu được nỗi vất vả của nhà nông, Công Ty Minh Long quyết
                tâm phục vụ vì lợi ích người nông dân. Các sản phẩm do Công ty
                Minh Long sản xuất và phân phối luôn đáp ứng các tiêu chí khắt
                khe về chất lượng, được các cơ quan quản lý công nhận, được
                người dân tin dùng.
              </p>
