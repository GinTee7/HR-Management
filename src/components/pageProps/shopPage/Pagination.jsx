      ...
      {currentItems.map((item) => (
        ...
        >
          ...
          <div className="flex flex-col items-center text-center">
            ...
            >
              <MdOutlineArrowForwardIos className="text-xs" /> Xem chi tiết
            </Link>
          </div>
        </div>
      ))}
          ...
          {categories.map((cat) => (
            <div
              ...
              className={`text-center cursor-pointer ${
                selectedCategory === cat.id ? "border-b-4 border-blue-500" : ""
              }`}
              onClick={() => {
      ...
      {pageCount > 1 && (
        <div className="flex flex-col items-center mt-6">
          ...
          <p className="mt-4 text-gray-700">
            Hiển thị từ {filteredItems.length > 0 ? itemOffset + 1 : 0} đến{" "}
