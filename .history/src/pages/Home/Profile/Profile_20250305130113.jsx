                ...
                <div className='flex flex-col'>
                    ...
                    <div className='xl:w-[80%] lg:w-[90%] md:w-[90%] sm:w-[92%] w-[90%] mx-auto flex flex-col gap-4 items-center mt-4'>
                        <p className='text-center text-gray-700 w-fit dark:text-gray-400 text-md'>
                            Chúng tôi là đại lý chuyên cung cấp các loại thuốc
                            bảo vệ thực vật, phân bón hữu cơ, hạt giống và dụng
                            cụ nông nghiệp chất lượng cao, giúp bà con nông dân
                            tăng năng suất và bảo vệ mùa màng.
                        </p>
