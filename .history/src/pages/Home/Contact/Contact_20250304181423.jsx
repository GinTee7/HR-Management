            ...
            <div className='grid grid-cols-1 gap-8 md:grid-cols-2'>
                ...
                <div className='p-6 bg-gray-100 rounded-lg shadow-md'>
                    ...
                    <p className='flex items-center gap-3 mb-3 text-lg text-gray-700'>
                        <FaMapMarkerAlt className='text-red-500' /> Số 98, Ấp
                        Đông Thành, Xã Thạnh Đông A, Tân Hiệp, Kiên Giang
                    </p>
                    <p className='flex items-center gap-3 mb-3 text-lg text-gray-700'>
                        <FaClock className='text-blue-500' /> Thứ 2 đến Thứ 7:
                        7h30 đến 17h
                    </p>
                    <p className='flex items-center gap-3 mb-3 text-lg text-gray-700'>
                ...
                <div className='overflow-hidden rounded-lg shadow-md'>
                    <iframe
                        ...
                        src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3878.01307424464!2d105.0866174!3d9.8702087!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTLCsDUyJzEyLjciTiAxMDXCsDA1JzEyLjciRQ!5e0!3m2!1sen!2s!4v1645623045709!5m2!1sen!2s'
                        allowFullScreen=''
                        loading='lazy'
                    ></iframe>
                </div>
