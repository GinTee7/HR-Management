        ...
        <div className='p-8 bg-white rounded-lg shadow-lg'>
            ...
            >
                <input
                    ...
                    className='border-2 border-gray-400 input-field'
                />
                ...
                <button
                    type='submit'
                    className='w-full px-6 py-3 text-white transition-all rounded-lg bg-gradient-to-r from-blue-500 to-indigo-600 hover:shadow-lg hover:from-indigo-500 hover:to-blue-600 md:w-auto'
                >
                    GỬI CHO CHÚNG TÔI
                </button>
            </form>
...
const ContactPage = () => {
    return (
        ...
        >
            <div className='container max-w-4xl p-10 mx-auto bg-white shadow-2xl rounded-2xl'>
...
const inputField =
    'w-full p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none';
