                    ...
                    {servicesData.length > 0 ? (
                        <Slider {...sliderSettings} className='relative pb-8'>
                            {servicesData.map((service, index) => (
                                ...
                                >
                                    <div className='relative flex flex-col items-center p-10 overflow-hidden bg-white border border-gray-200 shadow-md rounded-2xl'>
                                        ...
                                        <div className='w-full mt-4 text-center'>
                                            <span className='px-3 py-1 text-sm text-green-600 border border-green-600 rounded-full bg-slate-500'>
                                                THUỐC TRỪ CỎ
                                            </span>
