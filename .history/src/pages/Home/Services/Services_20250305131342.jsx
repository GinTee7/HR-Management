            ...
            <div className='container mx-auto'>
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3 lg:grid-cols-4'>
                    {servicesData.map(service => (
                        <div
                            key={service.id}
                            className='flex flex-col items-center p-4 text-center bg-white border border-gray-200 shadow-lg rounded-2xl'
                            data-aos='fade-up'
                        >
                            <span
                            ...
                            <img
                                ...
                                alt={service.name}
                                className='object-cover w-40 h-40 mb-4 rounded-lg'
                            />
                            ...
                            <button className='flex items-center gap-2 px-6 py-2 mt-4 text-white bg-green-500 rounded-lg hover:bg-green-600'>
