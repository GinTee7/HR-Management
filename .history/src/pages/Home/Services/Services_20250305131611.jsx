            ...
            <div className='container mx-auto'>
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-3 lg:grid-cols-4'>
                    {servicesData.map(service => (
                        <div
                            key={service.id}
                            className='flex flex-col items-center p-6 text-center bg-white border border-gray-200 shadow-lg rounded-2xl'
                            data-aos='fade-up'
                        >
                            <span
                            ...
                            <div className='flex items-center gap-2 mt-4'>
                                <input
                                    ...
                                    className='w-16 p-2 text-lg border rounded-lg'
                                />
                                <button className='flex items-center gap-2 px-6 py-2 text-white bg-green-500 rounded-lg hover:bg-green-600'>
