...
const Services = () => {
    ...
    return (
        <div className='bg-[#F2F8FC]'>
            <div className='py-10 pb-12 lg:py-28'>
                    ...
                    {servicesData.length > 0 ? (
                        <Slider {...sliderSettings} className='relative pb-8'>
                            {servicesData.map((service, index) => (
                                ...
                                >
                                    <div className='relative flex flex-col items-center p-4 overflow-hidden bg-white border border-gray-200 shadow-md rounded-2xl'>
