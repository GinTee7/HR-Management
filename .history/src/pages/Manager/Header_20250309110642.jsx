          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative flex items-center gap-2">
              <button className="w-10 h-10 overflow-hidden border-2 border-white rounded-full">
                <img src={Logo} alt="User Avatar" className="object-cover w-full h-full" />
              </button>
              <span className="text-white">{user?.name || "Đại lý"}</span>
            </div>
            ...
            <div className="relative language-dropdown">
              ...
              >
                <img src={currentLanguage.flag} alt={currentLanguage.name} className="w-5 h-5 mr-2 rounded-full" />
