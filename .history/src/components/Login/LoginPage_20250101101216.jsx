        ...
        >
          ...
          <form className="flex flex-col w-full gap-5">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              type="submit"
              className="relative w-full py-4 text-lg font-bold text-white bg-gradient-to-r from-[#2E4F4F] to-[#3A6565] rounded-lg shadow-md transition-all duration-300 hover:before:bg-[#3A6565] focus:outline-none focus:ring-2 focus:ring-[#2E4F4F]"
            >
              Login
            </motion.button>
