    ...
    <div className="flex items-center justify-center min-h-screen bg-[#E7F0FD]">
      <div className="flex shadow-xl bg-white border border-[#2E4F4F] rounded-lg w-[1100px] h-[600px] overflow-hidden">
        ...
        <div className="flex items-center justify-center w-1/2 bg-[#2E4F4F] rounded-l-lg">
          <img src={logo} alt='Logo' className='object-cover w-full h-full rounded-l-lg' />
            <img
              src={logo}
              alt="Logo"
              className="object-cover w-64 h-64 mb-4 border-4 border-white rounded-full shadow-md"
            />
            <img src={logo} alt="Enterprise Logo" className="object-cover border-4 border-white rounded-full shadow-md w-96 h-96" />
          </div>
        </div>
