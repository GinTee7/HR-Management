...
const LoginPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#E7F0FD] rounded-lg">
      <div className="flex shadow-xl bg-white border border-[#2E4F4F] rounded-lg w-[1100px] h-[600px] overflow-hidden">
        <div className="flex items-center justify-center w-1/2 bg-[#2E4F4F] rounded-l-xl">
          <img
            src={logo}
            alt="Enterprise Logo"
            className="object-cover w-[90%] h-[90%] shadow-md rounded-xl"
          />
        </div>

        <div className="flex flex-col justify-center w-1/2 p-10 bg-white rounded-r-xl">
