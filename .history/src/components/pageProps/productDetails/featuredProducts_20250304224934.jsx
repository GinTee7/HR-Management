...
const FeaturedProductsSection = () => {
    const [products] = useState([
        ...
        },
        {
            ...
            price: '200.000₫',
            features:
                'Cung cấp dinh dưỡng và tăng cường sức khỏe cho cây trồng.',
            usage: 'Phù hợp cho nhiều loại cây trồng',
            packaging: 'Chai 750ml'
        },
        {
            id: 4,
            img: 'https://nongnghiepdep.com/wp-content/uploads/2023/12/thuoc-tru-sau-bestkill.jpg',
            ...
            price: '220.000₫',
            features: 'Giúp cây phát triển nhanh hơn và tăng năng suất.',
            usage: 'Tối ưu cho lúa và hoa màu',
            packaging: 'Chai 500ml'
        }
    ]);
