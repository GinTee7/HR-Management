            ...
            {currentItems.map(item => (
                ...
                >
                    ...
                    <div className='flex flex-col items-center text-center'>
                        ...
                        <Link
                            to={`/product/${item._id}`}
                            className='flex items-center gap-2 px-5 py-2 mt-4 text-sm font-medium text-white transition-all bg-gradient-to-r from-blue-700 to-indigo-800 rounded-lg shadow-md hover:shadow-lg hover:scale-105'
                        >
