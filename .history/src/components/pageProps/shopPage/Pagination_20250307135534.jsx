    ...
    return (
        <div className='grid grid-cols-1 gap-6 p-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
            {currentItems.map(item => (
                ...
                >
                    {/* Ảnh sản phẩm (Lấy full ảnh, không cắt) */}
                    <div className='flex items-center justify-center w-full bg-gray-100 h-60 rounded-t-3xl'>
                        <img
                            className='object-contain max-w-full max-h-full rounded-t-3xl'
