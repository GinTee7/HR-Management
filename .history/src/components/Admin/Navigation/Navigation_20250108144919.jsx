...
import userImage from "../../Login/image/Avatar.jpg";
...
Navigation.propTypes = {
  ...
  groupButton: PropTypes.arrayOf(PropTypes.object).isRequired,
  onSendEmail: PropTypes.func,
  onCreateIntern: PropTypes.func,
