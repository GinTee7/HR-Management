                        ...
                        <div className='grid grid-cols-1 gap-6 sm:grid-cols-2'>
                            ...
                            <div className='flex flex-col justify-center gap-6 sm:pt-0'>
                                ...
                                >
                                    ...
                                    hoài bão phát triển nông nghiệp của những
                                    con người đã có hơn 30 năm gắn bó với nông
                                    nghiệp.
                                    <br />
                                    <br />
                                    Thấy hiểu được nỗi vất vả của nhà nông, nên
                                    Công Ty Minh Long quyết tâm phục vụ vì lợi
                                    ích người nông dân. Các sản phẩm do Công ty
                                    Minh Long sản xuất và phân phối luôn đáp ứng
                                    các tiêu chí khắt khe về chất lượng, được
                                    các cơ quan quản lý công nhận, được người
                                    dân tin dùng.
                                </p>
